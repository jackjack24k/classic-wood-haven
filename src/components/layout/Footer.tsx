    ...
    <footer className="bg-wood-dark text-white pt-12 pb-6">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1 lg:col-span-1">
            <Link to="/" className="inline-block mb-4">
              <span className="text-2xl font-serif font-bold text-white">Whimsy</span>
            </Link>
            <p className="text-sm text-gray-300 mb-4">
              Elegant wooden furniture crafted with care and attention to detail.
          ...
          <div>
            ...
            <form className="flex">
              <input 
                ...
                className="bg-white bg-opacity-20 text-white placeholder-gray-300 px-4 py-2 rounded-l-md focus:outline-none flex-grow"
                required
              />
              <button 
                type="submit"
                className="bg-gold text-white px-4 py-2 rounded-r-md hover:bg-opacity-90 transition-colors"
              >
                Join
              </button>
            </form>
        ...
        <div className="mt-12 pt-6 border-t border-gray-700 text-center text-sm text-gray-400">
          <p>© {new Date().getFullYear()} Whimsy. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
